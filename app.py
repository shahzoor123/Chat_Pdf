...
def main():
    ...
    st.write(bot_template.replace("{{MSG}}", "Hello Humans"), unsafe_allow_html=True)
    
    with st.sidebar:
        st.subheader("Your documents")
        
        pdf_docs  = st.file_uploader("Uploads your PDFS here and click on Process", accept_multiple_files=True)
